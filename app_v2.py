...
with tab_calc:
  ...
  if st.session_state.current_schedule_df.empty:
    ...
    for emp_name in unique_emps:
      ...
      # Procent potrącenia za nieobecności
      ...
      # Przetwarzanie szczegółowej listy nieobecnych dni z % udziale w pracy
      absences_list = []
    ...
    # =========================================================
    # NOWA SEKCJA: IMPREZY / PASKI DO WYDRUKU DLA PRACOWNIKÓW
    # =========================================================
    st.markdown("---")
    st.subheader("🧾 4. Imienne Paski Premiowe do Wydruku")
            ...
            <div class="pay-slip">
                ...
                <div style="display: flex; justify-content: space-between; margin-bottom: 15px;">
                    ...
                    <div style="text-align: right;">
                        ...
                        <p style="margin:3px 0; font-size:18px; color:#16a34a;"><strong>Należna premia:</strong> {e_det['calculated_bonus']:,.2f} zł</p>
                    </div>
                </div>
            """,
          unsafe_allow_html=True,
      ...
      st.markdown(
          f"""
                ...
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <div>
                        <p style="margin:2px 0;"><strong>Nadgodziny:</strong> {e_det['total_ot']} godz. ({e_det['ot_pay']:,.2f} zł)</p>
                        <p style="margin:2px 0;"><strong>Premie specjalne:</strong> {e_det['spec_bonus_val']:,.2f} zł</p>
                    </div>
